...
#
#   - added YoloV7 model common modules (ref: https://github.com/WongKinYiu/yolov7/blob/main/models/common.py)
#   - added PoolFormer model blocks (ref: https://github.com/sail-sg/poolformer/blob/main/models/poolformer.py)
#   - Residual Bifusion Block (RBBlock) and Bottom-up Fusion Module (BFM) in PRB-FPN
#     - https://doi.org/10.1109/TIP.2021.3118953
"""
Common modules
"""
...
##### end of Pytorch-Image-Models (timm) #####


##### Pool Transformer #####

# ref: https://github.com/sail-sg/poolformer/blob/main/models/poolformer.py
class PatchEmbed(nn.Module):
    # PatchEmbed https://github.com/sail-sg/poolformer
    """
    Patch Embedding that is implemented by a layer of conv. 
    Input: tensor in shape [B, C, H, W]
    Output: tensor in shape [B, C_new, H/stride, W/stride]
    """
    # Notice in_chans, embed_dim arg modified to come first before other args
    def __init__(self, in_chans=3, embed_dim=768, 
                 patch_size=16, stride=16, padding=0, norm_layer=None):
        super().__init__()
...
class PoolFormerBlock(nn.Module):
    ...
    """
    # drop, drop_path arg are modified to come before act_layer, norm_layer etc
